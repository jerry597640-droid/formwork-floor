...
function beam(w,L,E,I,mode){
 if(!['simple','continuous2','continuous'].includes(mode))throw new Error('不支援的梁分析模式');
 const ends=mode==='simple'?[[0,0]]:mode==='continuous2'?[[0,-w*L*L/8],[-w*L*L/8,0]]:[[0,-w*L*L/10],[-w*L*L/10,-w*L*L/10],[-w*L*L/10,0]];
